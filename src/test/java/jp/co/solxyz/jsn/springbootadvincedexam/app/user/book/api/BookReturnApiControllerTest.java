...
class BookReturnApiControllerTest {
    ...
    void shouldReturnBookWhenValidRequest() {
        ...
        verify(bookReturnService, times(1)).returnBook(userId, isbn);
    ...
    void shouldReturnBadRequestWhenReturnBookInfoIsNull() {
        ...
        verify(bookReturnService, never()).returnBook(userId, isbn);
    ...
    void shouldReturnBadRequestWhenIsbnIsNull() {
        ...
        verify(bookReturnService, never()).returnBook(anyString(), anyString());
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
    }
    ...
    void shouldReturnBadRequestWhenNoSuchElementExceptionIsThrown() {
        ...
        when(userDetails.getUserId()).thenReturn(userId);
        doThrow(NoSuchElementException.class).when(bookReturnService).returnBook(userId, isbn);
